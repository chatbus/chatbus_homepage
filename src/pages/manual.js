...
const ManualPage = ({data}) => {
  ...
  return (
        <div className="w-full container">
            ...
            >
            <h2 className="text-center mb-8 text-3xl font-bold leading-snug text-dark sm:text-4xl sm:leading-snug md:text-[45px] md:leading-snug md:pt-[50px] lg:pt-[50px]">메뉴얼</h2>
