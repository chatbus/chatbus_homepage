            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp mb-10">
                <div className="h-150px w-[150px] relative z-10 mx-auto mb-6 rounded-full">
                  <StaticImage src="../images/user-doney.jpg" alt="멤버캐릭터" className="w-full rounded-full" />
                ...
                <div>
                  <h4 className="mb-2 text-lg font-semibold text-dark">{member.name}</h4>
                  <p className="mb-5 text-sm font-medium text-body-color">{member.desc}</p>
                  <div className="flex items-center justify-center">
                    <Link href="/" className="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-primary">
