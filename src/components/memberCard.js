...
const MemberCard = ({ members }) => {
  return (
    <div className="w-full px-4 text-center">
      ...
      >
      <h2 className="mb-8 text-3xl font-bold leading-snug text-dark sm:text-4xl sm:leading-snug md:text-[45px] md:leading-snug md:pt-[50px] lg:pt-[50px]">멤버 소개</h2>
                      ...
                      <div className="wow fadeInUp mb-10">
                        ...
                        <div>
                          ...
                          <div className="flex items-center justify-center">
                            ...
                            {/*  </svg>*/}
                            {/*</a>*/}
                            <a href={member.frontmatter.github} target="_blank" rel="noreferrer">
                              <StaticImage src="../images/github.png" alt="github" style={{width:'20px', height:'20px'}}/>
                            </a>
                            <a href={member.frontmatter.linkdin} target="_blank" rel="noreferrer">
                              <StaticImage src="../images/linkdin.png" alt="linkdin" style={{width:'20px', height:'20px'}}/>
                            </a>
                            <a href={member.frontmatter.homepage} target="_blank" rel="noreferrer">
